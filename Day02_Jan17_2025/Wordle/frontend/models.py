...
class DailyWord(models.Model):
    ...
    is_active = models.BooleanField(
        default=False
    )  # Optional: for marking the active word
...
class Guess(models.Model):
    ...
    daily_word = models.ForeignKey(
        DailyWord, on_delete=models.CASCADE, related_name="guesses"
    )
...
class GameSession(models.Model):
    ...
    player = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="game_sessions"
    )
    daily_word = models.ForeignKey(
        DailyWord, on_delete=models.CASCADE, related_name="game_sessions"
    )
